...
Step 3: Start the service. (it is configured to run on port 3000). Run the following command in your terminal

```bash
$ npm run start:dev
```

Step 4: On your web browser, go to local host on port 3000 to see the swagger api documentation
